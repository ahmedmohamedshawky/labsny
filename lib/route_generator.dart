...
import 'package:food_delivery_app/src/pages/clothe.dart';
import 'package:food_delivery_app/src/pages/filtte_show.dart';
import 'package:food_delivery_app/src/pages/notifications.dart';
import 'package:food_delivery_app/src/pages/offers.dart';
...
class RouteGenerator {
  static Route<dynamic> generateRoute(RouteSettings settings) {
    ...
    switch (settings.name) {
      ...
      case '/Offers':
        return MaterialPageRoute(builder: (_) => OffersWidget());
      case '/Filter':
        return MaterialPageRoute(builder: (_) => FilterShow());
      case '/Chat':
      ...
      case '/Food':
        return MaterialPageRoute(builder: (_) => ClotheWidget(routeArgument: args as RouteArgument));
      case '/Clothe':
        return MaterialPageRoute(builder: (_) => ClotheWidget(routeArgument: args as RouteArgument));
      case '/Category':
