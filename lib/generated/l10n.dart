...
class S {
  ...
  /// `Search for shops or clothes`
  String get search_for_shops_or_clothes {
    return Intl.message(
      'Search for shops or clothes',
      name: 'search_for_shops_or_clothes',
      desc: '',
      args: [],
    );
  }
  ...
  String get double_click_on_the_clothe_to_add_it_to_the {
    return Intl.message(
      'Double click on the clothe to add it to the cart',
  ...
  String get select_extras_to_add_them_on_the_clothe {
    return Intl.message(
      'Select extras to add them on the clothe',
  ...
  String get longpress_on_the_clothe_to_add_suplements {
    return Intl.message(
      'Long press on the clothe to add suplements',
  ...
  String get you_can_discover_shops {
    return Intl.message(
      'You can discover shops & clothes arround you and choose you best meal after few minutes we prepare and delivere it for you',
  ...
  String get you_must_add_clothes_of_the_same_shops_choose_one {
    return Intl.message(
      'You must add clothes of the same shop choose one shop only!',
  ...
  String get reset_your_cart_and_order_clothes_form_this_shop {
    return Intl.message(
      'Reset your cart and order clothes form this shop',
  ...
  String get keep_your_old_clothes_of_this_shop {
    return Intl.message(
      'Keep your old clothes of this shop',
  ...
  String the_clothe_was_removed_from_your_cart(Object foodname) {
    return Intl.message(
      'The $foodname was removed from your cart',
  ...
  String get shop_refreshed_successfuly {
    return Intl.message(
      'Shop refreshed successfully',
      name: 'shop_refreshed_successfuly',
      desc: '',
      args: [],
    );
  }
  ...
  String get tell_us_about_this_shop {
    return Intl.message(
  ...
  String get how_would_you_rate_this_shop_ {
    return Intl.message(
  ...
  String get tell_us_about_this_clothe {
    return Intl.message(
      'Tell us about this clothe',
  ...
  String get the_shop_has_been_rated_successfully {
    return Intl.message(
      'The shop has been rated successfully',
  ...
  String get the_clothe_has_been_rated_successfully {
    return Intl.message(
      'The clothe has been rated successfully',
  ...
  String get this_shop_is_closed_ {
    return Intl.message(
      'This shop is closed !',
  ...
  /// `How would you rate this restaurant ?`
  String get how_would_you_rate_this_shop {
    return Intl.message(
      'How would you rate this shop ?',
  ...
  String get thisFoodWasAddedToFavorite {
    return Intl.message(
      'This clothe was added to favorite',
  ...
  String get thisClotheWasRemovedFromFavorites {
    return Intl.message(
      'This clothe was removed from favorites',
  ...
  /// `Clothes refreshed successfully`
  String get clotheRefreshedSuccessfuly {
    return Intl.message(
      'Clothes refreshed successfully',
      name: 'clotheRefreshedSuccessfuly',
      desc: '',
      args: [],
    );
  }
  ...
  String get deliveryAddressOutsideTheDeliveryRangeOfThisShops {
    return Intl.message(
      'Delivery address outside the delivery range of this shops.',
  ...
  String get thisShopNotSupportDeliveryMethod {
    return Intl.message(
      'This shop not support delivery method.',
  ...
  String get oneOrMoreClothesInYourCartNotDeliverable {
    return Intl.message(
      'One or more clothes in your cart not deliverable.',
  ...
  String get clickOnTheClotheToGetMoreDetailsAboutIt {
    return Intl.message(
      'Click on the Clothe to get more details about it',
