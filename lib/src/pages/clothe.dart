...
import 'package:food_delivery_app/src/controllers/clothes_controller.dart';
...
class ClotheWidget extends StatefulWidget {
  RouteArgument routeArgument;

  ClotheWidget({Key key, this.routeArgument}) : super(key: key);

  @override
  _ClotheWidgetState createState() {
    return _ClotheWidgetState();
  }
}

class _ClotheWidgetState extends StateMVC<ClotheWidget> {
  ClothesController _con;

  _ClotheWidgetState() : super(ClothesController()) {
    _con = controller;
  }

  @override
  void initState() {
    _con.listenForClothe(clotheId: widget.routeArgument.id);
    _con.listenForCart();
    _con.listenForFavorite(clotheId: widget.routeArgument.id);
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: _con.clothes == null || _con.clothes?.media == null
          ? CircularLoadingWidget(height: 500)
          : RefreshIndicator(
              onRefresh: _con.refreshClothe,
              child: Stack(
                fit: StackFit.expand,
                children: <Widget>[
                  Container(
                      ...
                      slivers: <Widget>[
                        SliverAppBar(
                          ...
                          flexibleSpace: FlexibleSpaceBar(
                            ...
                            background: Hero(
                              tag: widget.routeArgument.heroTag ?? '' + _con.clothes.id,
                            ...
                            child: Wrap(
                              ...
                              children: [
                                    ...
                                    Expanded(
                                      ...
                                      child: Column(
                                        ...
                                        children: <Widget>[
                                          ...
                                          _con.clothes.discount_price > 0
                                              ? Helper.getPrice(_con.clothes.discount_price, context,
                                ...
                                Row(
                                  children: <Widget>[
                                    Container(
                                      ...
                                      child: /*Helper.canDelivery(_con.food.restaurant) &&*/ _con.clothes.deliverable
                                          ? Text(
                                    ...
                                    Container(
                                        ...
                                        child: Text(
                                          _con.clothes.weight.toString() + " " + _con.clothes.unit,
                                          style: Theme.of(context).textTheme.caption.merge(TextStyle(color: Theme.of(context).primaryColor)),
                                        )),
                                    SizedBox(width: 5),
                                    Container(
                                        ...
                                        decoration: BoxDecoration(color: Theme.of(context).focusColor, borderRadius: BorderRadius.circular(24)),
                                        child: Text(
                                          _con.clothes.package_items_count.toString() + " " + S.of(context).items,
                                          style: Theme.of(context).textTheme.caption.merge(TextStyle(color: Theme.of(context).primaryColor)),
                                        )),
                                  ],
                                ),
                                Divider(height: 20),
                                Helper.applyHtml(context, _con.clothes.description, style: TextStyle(fontSize: 12)),
                                ListTile(
                                  dense: true,
                               ...
                               /* _con.food.extraGroups == null
                                ...
                                Helper.applyHtml(context, _con.clothes.ingredients, style: TextStyle(fontSize: 12)),
                                ListTile(
                                  dense: true,
                                  contentPadding: EdgeInsets.symmetric(vertical: 10),
                                  leading: Icon(
                               ...
                               /* Wrap(
                                  spacing: 8,
                                  runSpacing: 8,
                                  children: List.generate(_con.clothes.nutritions.length, (index) {
                                    return Container(
                                ...
                                /*Clothe reviews*/
                               /* ReviewsListWidget(
                                  reviewsList: _con.clothes.foodReviews,
                                ),*/
                              ],
                            ),
                          ),
                  ...
                  Positioned(
                    ...
                    child: _con.loadCart
                        ...
                        : ShoppingCartFloatButtonWidget(
                            ...
                            routeArgument: RouteArgument(param: '/Clothe', id: _con.clothes.id),
                          ),
                  ),
                  Positioned(
                    bottom: 0,
                                      ...
                                      : FlatButton(
                                          onPressed: () {
                                            if (currentUser.value.apiToken == null) {
                                              ...
                                              _con.addToFavorite(_con.clothes);
                                            }
                                          },
                                          padding: EdgeInsets.symmetric(vertical: 14),
                                          color: Theme.of(context).accentColor,
                                ...
                                Stack(
                                  ...
                                  children: <Widget>[
                                    SizedBox(
                                     ...
                                     /*Altra Dialog For Add Clothe To cart*/
                                     /* child: FlatButton(
                                        onPressed: () {
                                          if (currentUser.value.apiToken == null) {
                                            Navigator.of(context).pushNamed("/Login");
                                          } else {
                                            if (_con.isSameRestaurants(_con.clothes)) {
                                              _con.addToCart(_con.clothes);
                                            } else {
                                              showDialog(
                                                context: context,
