          ...
          child: Column(
            ...
            children: List.generate(settingsRepo.setting.value.homeSections.length, (index) {
              ...
              switch (_homeSection) {
                ...
                case 'top_shops':
                  return CardsCarouselWidget(shopsList: _con.topShops, heroTag: 'home_top_shops');
                ...
                case 'trending_week':
                  return ClothesCarouselWidget(clothesList: _con.trendingClothes, heroTag: 'home_clothes_carousel');
                case 'categories_heading':
                  return Padding(
                    ...
                    child: ListTile(
                      ...
                      title: Text(
                        S.of(context).clothes_categories,
                        style: Theme.of(context).textTheme.headline4,
                      ),
                    ),
                  );
