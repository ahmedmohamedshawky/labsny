                ...
                : SingleChildScrollView(
                    child: Column(
                      children: <Widget>[
                              ...
                              children: <Widget>[
                                Padding(
                                  ...
                                  child: SizedBox(
                                    ...
                                    child: Hero(
                                      tag: widget.routeArgument.heroTag + _con.order.clothesOrders[0].clothes.shop.id,
                                      child: CachedNetworkImage(
                                        fit: BoxFit.cover,
                                      //  imageUrl: _con.order.clothesOrders[0].clothes.shop.image.url,
                                ...
                                SizedBox(
                                  ...
                                  child: Chip(
                                    ...
                                    label: Row(
                                      ...
                                      children: <Widget>[
                                        Text(_con.order.clothesOrders[0].clothes.shop.rate,
                        ...
                        SizedBox(height: 10),
                        Text(
                          _con.order.clothesOrders[0].clothes.shop.name,
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              Text(S.of(context).how_would_you_rate_this_shop_,
                              ...
                              Row(
                                ...
                                children: List.generate(5, (index) {
                                  return InkWell(
                                    onTap: () {
                                      setState(() {
                                        _con.shopReview.rate = (index + 1).toString();
                                      });
                                    },
                                    child: index < int.parse(_con.shopReview.rate)
                              ...
                              TextField(
                                onChanged: (text) {
                                  _con.shopReview.review = text;
                                },
                                maxLines: 2,
                                textAlign: TextAlign.center,
                                decoration: InputDecoration(
                                  contentPadding: EdgeInsets.all(12),
                                  hintText: S.of(context).tell_us_about_this_shop,
                              ...
                              FlatButton.icon(
                                ...
                                onPressed: () {
                                  _con.addShopReview(_con.shopReview);
                        ...
                        Column(
                          children: List.generate(_con.clothesOfOrder.length, (index) {
                            return Container(
                              width: MediaQuery.of(context).size.width,
                              margin: EdgeInsets.symmetric(vertical: 20, horizontal: 20),
                              padding: EdgeInsets.symmetric(vertical: 30, horizontal: 20),
                              ...
                              child: Column(
                                ...
                                mainAxisSize: MainAxisSize.max,
                                children: <Widget>[
                                  Text(_con.clothesOfOrder[index].clothes.name, textAlign: TextAlign.center, style: Theme.of(context).textTheme.subtitle1),
                                  SizedBox(height: 10),
                                  Row(
                                    mainAxisAlignment: MainAxisAlignment.center,
                                    children: List.generate(5, (star) {
                                      return InkWell(
                                        onTap: () {
                                          setState(() {
                                            _con.clothesReviews[index].rate = (star + 1).toString();
                                          });
                                        },
                                        child: star < int.parse(_con.clothesReviews[index].rate)
                                            ? Icon(Icons.star, size: 40, color: Color(0xFFFFB24D))
                                            : Icon(Icons.star_border, size: 40, color: Color(0xFFFFB24D)),
                                      );
                                    }),
                                  ...
                                  TextField(
                                    onChanged: (text) {
                                      _con.clothesReviews[index].review = text;
                                    },
                                    maxLines: 2,
                                    textAlign: TextAlign.center,
                                    decoration: InputDecoration(
                                      contentPadding: EdgeInsets.all(12),
                                      hintText: S.of(context).tell_us_about_this_clothe,
                                      hintStyle: Theme.of(context).textTheme.caption.merge(TextStyle(fontSize: 14)),
                                      border: OutlineInputBorder(borderSide: BorderSide(color: Theme.of(context).focusColor.withOpacity(0.1))),
                                      focusedBorder: OutlineInputBorder(borderSide: BorderSide(color: Theme.of(context).focusColor.withOpacity(0.2))),
                                      enabledBorder: OutlineInputBorder(borderSide: BorderSide(color: Theme.of(context).focusColor.withOpacity(0.1))),
                                  ...
                                  FlatButton.icon(
                                    padding: EdgeInsets.symmetric(vertical: 10, horizontal: 18),
                                    onPressed: () {
                                      _con.addClothesReview(_con.clothesReviews[index], _con.clothesOfOrder[index].clothes);
                                      FocusScope.of(context).unfocus();
                                    },
                                    shape: StadiumBorder(),
                                    label: Text(
