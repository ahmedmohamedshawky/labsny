...
import '../elements/ClotheGridItemWidget.dart';
import '../elements/ClotheListItemWidget.dart';
              ...
              _con.clothes.isEmpty
                  ...
                  : Offstage(
                      ...
                      child: GridView.count(
                        ...
                        children: List.generate(_con.clothes.length, (index) {
                          return ClotheGridItemWidget(
                              ...
                              onPressed: () {
                                if (currentUser.value.apiToken == null) {
                                  ...
                                  if (_con.isSameShops(_con.clothes.elementAt(index))) {
                                    _con.addToCart(_con.clothes.elementAt(index));
                                  } else {
                                    showDialog(
                                      context: context,
                                      builder: (BuildContext context) {
                                        ...
                                        return AddToCartAlertDialogWidget(
                                            oldClothes: _con.carts.elementAt(0)?.clothes,
                                            newClothes: _con.clothes.elementAt(index),
                                            onPressed: (food, {reset: true}) {
                                              return _con.addToCart(_con.clothes.elementAt(index), reset: true);
                                            });
                                      },
                                    );
                                  }
