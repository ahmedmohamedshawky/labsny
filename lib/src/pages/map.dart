...
class _MapWidgetState extends StateMVC<MapWidget> {
  ...
  void initState() {
    ...
    _con.currentShop = widget.routeArgument?.param as Shop;
    if (_con.currentShop?.latitude != null) {
      // user select a restaurant
      _con.getShopLocation();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0,
        centerTitle: true,
        leading: _con.currentShop?.latitude == null
            ? new IconButton(
