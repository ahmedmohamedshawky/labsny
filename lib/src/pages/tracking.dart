...
import '../elements/ClothesOrderItemWidget.dart';
        ...
        bottomNavigationBar: Container(
          ...
          child: _con.order == null || _con.orderStatus.isEmpty
              ...
              : Column(
                  ...
                  children: <Widget>[
                    Text(S.of(context).how_would_you_rate_this_shop, style: Theme.of(context).textTheme.subtitle1),
                    Text(S.of(context).click_on_the_stars_below_to_leave_comments, style: Theme.of(context).textTheme.caption),
                    SizedBox(height: 5),
                    FlatButton(
                      onPressed: () {
                        Navigator.of(context).pushNamed('/Reviews', arguments: RouteArgument(id: _con.order.id, heroTag: "shop_reviews"));
                      },
                      padding: EdgeInsets.symmetric(vertical: 5),
                      shape: StadiumBorder(),
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: Helper.getStarsList(double.parse(_con.order.clothesOrders[0].clothes.shop.rate), size: 35),
                      ),
                    ),
                  ],
                ),
                                      ...
                                      child: ExpansionTile(
                                        ...
                                        children: <Widget>[
                                          Column(
                                            ...
                                            _con.order.clothesOrders.length,
                                            (indexFood) {
                                              return ClothesOrderItemWidget(
                                                  heroTag: 'my_order', order: _con.order, clotheOrder: _con.order.clothesOrders.elementAt(indexFood));
                                            },
                                          )),
                                          Padding(
