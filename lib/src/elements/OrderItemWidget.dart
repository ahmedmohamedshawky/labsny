...
import 'ClothesOrderItemWidget.dart';
                  ...
                  child: ExpansionTile(
                    ...
                    children: <Widget>[
                      Column(
                        ...
                        widget.order.clothesOrders.length,
                        (indexFood) {
                          return ClothesOrderItemWidget(
                              heroTag: 'mywidget.orders', order: widget.order, clotheOrder: widget.order.clothesOrders.elementAt(indexFood));
                        },
                      )),
                      Padding(
