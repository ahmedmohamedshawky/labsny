  ...
  Widget build(BuildContext context) {
    return Dismissible(
      ...
      child: InkWell(
        ...
        onTap: () {
          Navigator.of(context).pushNamed('/Clothe', arguments: RouteArgument(id: widget.cart.clothes.id, heroTag: widget.heroTag));
        },
        child: Container(
          ...
          child: Row(
            ...
            children: <Widget>[
              ClipRRect(
                ...
                //  imageUrl: widget.cart.clothes.image.thumb,
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Wrap(
                            ...
                            spacing: 5,
                            children: <Widget>[
                              Helper.getPrice(widget.cart.clothes.price, context, style: Theme.of(context).textTheme.headline4, zeroPlaceholder: 'Free'),
                              widget.cart.clothes.discount_price > 0
                                  ? Helper.getPrice(widget.cart.clothes.discount_price , context,
