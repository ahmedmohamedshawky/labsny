    ...
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Padding(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                hintText: S.of(context).search_for_shops_or_clothes,
          ...
          _con.shops.isEmpty && _con.clothes.isEmpty
                            ...
                            onTap: () {
                              Navigator.of(context).pushNamed('/Details',
                                  arguments: RouteArgument(
                                    id: '0',
                                    param: _con.shops.elementAt(index).id,
                                    heroTag: widget.heroTag,
                                  ));
                            },
                            child: CardWidget(shop: _con.shops.elementAt(index), heroTag: widget.heroTag),
                          );
                        },
                      ),
                    ],
