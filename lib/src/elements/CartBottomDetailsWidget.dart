                ...
                children: <Widget>[
                  ...
                  Row(
                    children: <Widget>[
                      ...
                      if (Helper.canDelivery(_con.carts[0].clothes.shop, carts: _con.carts))
                        Helper.getPrice(_con.carts[0].clothes.shop.delivery_fee, context,
                  ...
                  Row(
                    children: <Widget>[
                      Expanded(
                        child: Text(
                          '${S.of(context).tax} (${_con.carts[0].clothes.shop.default_tax}%)',
                          style: Theme.of(context).textTheme.bodyText1,
                        ),
                      ),
                    ...
                    children: <Widget>[
                      SizedBox(
                        ...
                        child: FlatButton(
                         ...
                         color: !_con.carts[0].clothes.shop.closed ? Theme.of(context).accentColor : Theme.of(context).focusColor.withOpacity(0.5),
                          shape: StadiumBorder(),
                          child: Text(
