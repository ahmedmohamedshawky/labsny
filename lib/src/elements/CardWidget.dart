...
class CardWidget extends StatelessWidget {
  ...
  CardWidget({Key key, this.shop, this.heroTag}) : super(key: key);
  @override
              ...
              Hero(
                ...
                child: ClipRRect(
                  ...
                  child: CachedNetworkImage(
                    ...
                    fit: BoxFit.cover,
                    imageUrl: (shop.media.first as Map)['url'],
                  ...
                  child: Column(
                    children: <Widget>[
                      FlatButton(
                        ...
                        onPressed: () {
                          Navigator.of(context).pushNamed('/Pages', arguments: new RouteArgument(id: '0', param: shop));
                        },
                      ...
                      shop.distance > 0
                          ? Text(
                              Helper.getDistance(shop.distance, Helper.of(context).trans(setting.value.distanceUnit)),
                              overflow: TextOverflow.fade,
                              maxLines: 1,
                              softWrap: false,
                            )
