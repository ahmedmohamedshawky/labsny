...
class GridItemWidget extends StatelessWidget {
  ...
  GridItemWidget({Key key, this.shop, this.heroTag}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      onTap: () {
        Navigator.of(context).pushNamed('/Details', arguments: RouteArgument(id: "0", param: shop.id, heroTag: heroTag));
      },
      child: Container(
